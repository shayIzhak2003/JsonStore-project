...
import { addToFavorites, getFavoriteMessageStatus } from '../../store/favoritesSlice';
...
const ProductSinglePage = () => {
  ...
  const addToFavoritesHandler = () => {
    dispatch(addToFavorites(product)); // Assuming addToFavorites action creator is correctly defined
  };
            ...
            <div className="product-single-r">
              <div className="product-details font-manrope">
                ...
                <div className="btns">
                  ...
                  <button type="button" className="add-to-cart-btn btn" onClick={addToFavoritesHandler}>
                    <i className="fas fa-heart "></i>
                    <span className="btn-text mx-2">add to favorites</span>
                  </button>
